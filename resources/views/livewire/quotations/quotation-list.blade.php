<div>
    <div class="p-4">
        <h2 class="text-xl text-center font-semibold">Cotizaciones</h2>

        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-4">
                <select wire:model="perPage" class="p-2 pl-3 pr-8 border border-gray-300 rounded-md">
                    <option value="5">5 por página</option>
                    <option value="10">10 por página</option>
                    <option value="20">20 por página</option>
                </select>
                <input wire:model="search" type="text" placeholder="Buscar"
                    class="p-2 pl-4 border border-gray-300 rounded-md w-72">
            </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-800 text-white">
                <tr>
                    <th wire:click="sortBy('project.name')"
                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium">
                        Proyecto</th>
                    <th wire:click="sortBy('client.name')"
                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium">
                        Cliente</th>
                    <th wire:click="sortBy('quotation_date')"
                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium">Fecha de Cotización</th>
                    <th wire:click="sortBy('validity_period')"
                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium">Período de Validez (días)</th>
                    <th wire:click="sortBy('total_quotation_amount')"
                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium">Monto Total de la Cotización</th>
                    <!-- Add other table headers based on your fields -->
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($quotations as $quotation)
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $quotation->project->name }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">{{ $quotation->validity_period }} días</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $quotation->total_quotation_amount }}</td>
                    <!-- Add other table data based on your fields -->
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        @else
        <p class="text-center text-gray-500">No hay cotizaciones disponibles.</p>
        @endif
    </div>
