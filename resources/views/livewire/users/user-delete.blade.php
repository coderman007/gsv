            ...
            <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white border border-red-500 rounded-xl modal-container md:max-w-md">
                ...
                <div class="px-6 py-4 text-left modal-content">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <x-secondary-button wire:click="deleteUser" class="mr-4 text-red-500 border border-red-500 shadow-lg hover:text-gray-50 hover:shadow-red-400 hover:bg-red-400">
                            Eliminar
                        </x-secondary-button>
                    </div>
                </div>
