<div class="bg-gray-50 p-6 rounded-lg">
    <label class="text-lg font-semibold text-gray-600 py-2">
        ...
        <div class="mb-4 grid grid-cols-7 gap-4">
            @foreach ($transports as $transport)
                ...
                <div class="col-span-1">
                    @if (in_array($transport->id, $selectedTransports))
                        <div class="mb-2">
                            ...
                            @error('requiredDays.' . $transport->id)
                            <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                    @endif
                ...
                <div class="col-span-2">
                    @if (in_array($transport->id, $selectedTransports))
                        <div class="mb-2">
                            <label for="partialCost{{ $transport->id }}"
        ...
        <div class="col-span-2 flex items-center">
            <label for="totalTransportCost" class="block text-lg text-gray-700">Total Transporte:</label>
