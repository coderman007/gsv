                    ...
                    @if (in_array($tool->id, $selectedTools))
                        <div class="flex items-center">
                            ...
                            <div class="flex flex-col">
                                <label for="efficiency_{{ $tool->id }}" class="text-sm text-gray-700 mb-1">Rendimiento:</label>
                            ...
                            <div class="flex flex-col">
                                ...
                                <input id="cost_{{ $tool->id }}" type="text"
                                       value="{{ $partialToolCosts[$tool->id] ?? '' }}"
...
{{--                                <!-- Días requeridos -->--}}
{{--                                <div class="flex flex-col">--}}
{{--                                    <label para="required_days_{{ $tool->id }}"--}}
{{--                                           class="text-sm text-gray-700 mb-1">Días:</label>--}}
{{--                                    <input wire:model.live="requiredDays.{{ $tool->id }}"--}}
{{--                                           id="required_days_{{ $tool->id }}" type="number"--}}
{{--                                           class="w-16 px-2 py-1 border-sky-300 rounded-md focus:outline-none focus:ring-sky-500 focus:border-sky-500">--}}
...
{{--                                    <label for="efficiency_{{ $tool->id }}" class="text-sm text-gray-700 mb-1">Rendimiento:</label>--}}
{{--                                    <input wire:model.live="efficiencies.{{ $tool->id }}"--}}
{{--                                           id="efficiency_{{ $tool->id }}" type="number"--}}
...
{{--                                           value="{{ $partialToolCosts[$tool->id] ?? '' }}"--}}
{{--                                           class="w-24 px-2 py-1 border border-sky-300 rounded-md focus:outline-none">--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        @endif--}}
{{--                    </div>--}}
...
{{--        <div class="bg-gray-50 p-2 rounded-lg mb-4 flex items-center">--}}
{{--            <label para="totalToolCost" class="block text-lg mr-4 font-medium text-gray-700">Total Herramientas:</label>--}}
{{--            <div class="relative rounded-md shadow-sm flex-1">--}}
{{--                <input type="text" readonly wire:model.live="formattedTotalToolCost"--}}
{{--                       class="text-right mt-1 p-2 block w-full border-sky-500 rounded-md bg-sky-100 focus:outline-none focus:ring-sky-500 focus:border-sky-500">--}}
{{--            </div>--}}
