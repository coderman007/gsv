<div class="relative inline-block text-center cursor-pointer group">
    ...
    <x-dialog-modal maxWidth="3xl" wire:model="openEdit">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
            <x-slot name="title">
                <h2 class="text-2xl font-semibold text-center text-gray-500 dark:text-white py-6">Editar Categoría de Proyecto</h2>
            </x-slot>
            ...
            <x-slot name="footer">
                <div class="flex justify-between gap-4 text-lg">
                    ...
                    <button type="submit" wire:click="updateCategory"
                        ...
                        <i class="fa-solid fa-square-pen mr-2 text-xl"></i> Actualizar
                    </button>
                </div>
            </x-slot>
        </div>
