                ...
                <div class="relative p-4 w-full max-w-md">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <div class="flex gap-3">
                            <button wire:click="deleteTransport" type="button"
                                ...
                                wire:loading.attr="disabled" wire:target="deleteTransport">
                                <span class="mx-1">
                            ...
                            <button wire:click="$set('openDelete', false)" type="button"
                                ...
                                <span class="pl-2 mx-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" fill="#FFFFFF" height="24px"
                                        viewBox="0 0 512 512">
                                        <path
