                    ...
                    <div class="relative p-4 w-full max-w-md max-h-[insert_valor_aqui]">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-2xl font-normal p-4 text-gray-500 dark:text-gray-400">¿Está seguro de realizar esta acción?</h3>
                                    ...
                                    <button wire:click="deletePosition" type="button"
                                        ...
                                        <span class="mx-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 512 512"
                                                ...
                                                <path
                                                    d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM231 127c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-71 71L376 232c13.3 0 24 10.7 24 24s-10.7 24-24 24l-182.1 0 71 71c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0L119 273c-9.4-9.4-9.4-24.6 0-33.9L231 127z" />
                                            </svg>
                                        </span>
                                        Estoy Seguro
                                    </button>
