<div>
    <button wire:click="$set('openCreate', true)"
        ...
        <span class="relative text-gray-500 transition duration-700 group-hover:text-white ease"><i
                class="fa fa-solid fa-users-between-lines text-xl"></i> Agregar Empleado</span>
    </button>
                        ...
                        <div>
                            <div
                                ...
                                <span class="pl-2 mx-1">
                                    <h2 class="mt-3 text-2xl text-center">Crear Mano de Obra</h2>
                                </span>
                            </div>
                            <div class="mt-5 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input wire:model="position" placeholder="Posición"
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input wire:model="basic" type="number" placeholder="Básico"
                                        class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input wire:model="benefitFactor" type="number" placeholder="Factor de Beneficio"
                                        class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input wire:model="realMonthlyCost" type="number" placeholder="Costo Mensual Real"
                                        class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <input wire:model="realDailyCost" type="number" placeholder="Costo Diario Real"
                                        class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
