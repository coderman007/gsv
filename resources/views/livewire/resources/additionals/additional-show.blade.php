            ...
            <x-slot name="content">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        <p id="name"
                           class="text-yellow-500 dark:text-yellow-200 text-2xl font-bold p-4 dark:bg-yellow-600 rounded-lg">{{ ucfirst($additional->name) }}</p>
                    </div>

                    <!-- Costo por día -->
                    <div class="space-y-2">
                        <label for="cost_per_day" class="font-semibold text-gray-700 dark:text-gray-300 text-lg">Costo
                            Diario:</label>
                        <div class="px-6 py-4 dark:text-lg">
                            <div class="bg-yellow-100 p-2 rounded-sm font-semibold text-center text-lg">
                                <span>$</span>
                                <span>{{ number_format($additional->unit_price, 2, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
