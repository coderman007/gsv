<div class="relative inline-block text-center cursor-pointer group">
    ...
    {{-- Modal de Confirmación de Eliminación del adicional. --}}
    @if ($openDelete)
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <div class="flex gap-3">
                                    <button wire:click="deleteAdditional" type="button"
                                            ...
                                            wire:click="updateAdditional" wire:loading.attr="disabled"
                                            wire:target="updateAdditional">
                                        <span class="mx-1">
