<div>
    <button wire:click="$set('openCreate', true)"
        ...
        <span class="relative text-gray-500 transition duration-700 group-hover:text-white ease"><i
                class="fa fa-solid fa-boxes text-xl"></i> Agregar Material</span>
    </button>
                ...
                <div class="w-1">
                    ...
                    <x-slot name="content">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <input wire:model="category" placeholder="Categoría"
                        ...
                        <!-- Referencia -->
                        <div class="px-5 pb-5">
                            <x-label class="text-left text-xl text-gray-700" value="Referencia" />
                            <input wire:model="reference" placeholder="Referencia"
                                class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <input wire:model="description" placeholder="Descripción"
                                class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <input wire:model="unitPrice" type="number" placeholder="Precio Unitario"
                                class="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-300 focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                        ...
                        <div class="mx-auto">
                            <div class="flex gap-16">
                                ...
                                <button type="button"
                                    ...
                                    wire:click="createMaterial" wire:loading.attr="disabled"
