<div class="relative inline-block text-center cursor-pointer group">
    ...
    <x-dialog-modal maxWidth="3xl" wire:model="openEdit">
        <div class="w-full mx-auto bg-white shadow-md p-6 rounded-md">
            <x-slot name="title">
                <h2 class="font-semibold text-2xl text-center pt-4 text-blue-500">Editar Material</h2>
            </x-slot>

            <x-slot name="content">
                <form wire:submit.prevent="updateMaterial" class="flex flex-col items-center mt-6 p-4 bg-gray-50 rounded-lg">
