<div>
    ...
    <x-dialog-modal maxWidth="3xl" wire:model="openCreate">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
            <x-slot name="title">
                <h2 class="text-2xl font-semibold text-center text-gray-500 dark:text-white py-6">Crear Política Comercial</h2>
            </x-slot>
            ...
            <x-slot name="content">
                <div class="border border-violet-500 shadow-sm shadow-violet-500 m-4 p-10 rounded-lg">
                    <form class="space-y-5 mx-auto">
                        ...
                        <div class="mb-5">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Nombre de la Política:</label>
                            <input wire:model="name" type="text" id="name"
                                   ...
                                   placeholder="Ingrese el nombre de la política" required/>
                            <x-input-error for="name"/>
                        </div>

                        <!-- Campo para el porcentaje -->
                        <div class="mb-5">
                            <label for="percentage" class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Porcentaje (%):</label>
