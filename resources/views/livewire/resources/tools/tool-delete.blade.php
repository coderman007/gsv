                    ...
                    <div class="relative p-4 w-full max-w-md max-h-[insert_valor_aqui]">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-2xl font-normal p-4 text-gray-500 dark:text-gray-400">¿Está seguro
                                    de
                                    hacer esto?</h3>

                                <div class="flex gap-3">
                                    <button wire:click="deleteTool" type="button"
                                        ...
                                        wire:click="deleteTool" wire:loading.attr="disabled" wire:target="deleteTool">
                                        <span class="mx-1">
                                    ...
                                    <button wire:click="$set('openDelete', false)" type="button"
                                        ...
                                        wire:click="$set('openDelete', false)" wire:loading.attr="disabled"
                                        wire:target="$set('openDelete', false)">
