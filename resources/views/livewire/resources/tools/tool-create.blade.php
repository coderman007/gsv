<div>
    <button wire:click="$set('openCreate', true)"
        ...
        <span class="relative text-gray-500 transition duration-700 group-hover:text-white ease"><i
                class="fa fa-solid fa-plus text-xl"></i> Nueva Herramienta</span>
    </button>

    <x-dialog-modal maxWidth="3xl" wire:model="openCreate">
        <div class="w-full mx-auto bg-white shadow-md p-6 rounded-md">
            <x-slot name="title">
                <h2 class="font-semibold text-2xl text-center pt-4 text-blue-500">Crear Herramienta</h2>
            </x-slot>

            <x-slot name="content">
                <form wire:submit.prevent="createTool" class="flex flex-col items-center mt-6 p-4 bg-gray-50 rounded-lg">
