<div>
    <button wire:click="$set('openCreate', true)"
        ...
        <span class="relative text-gray-500 transition duration-700 group-hover:text-white ease"><i
                class="fa fa-solid fa-screwdriver-wrench text-xl"></i> Agregar Herramienta</span>
    </button>
                        ...
                        <div>
                            <div
                                ...
                                <span class="pl-2 mx-1">
                                    <h2 class="mt-3 text-2xl text-center">Crear Herramienta</h2>
                                </span>
                            </div>
                        ...
                        <div class="mx-auto">
                            <div class="flex gap-16">
                                ...
                                <button type="button"
                                    ...
                                    wire:click="createTool" wire:loading.attr="disabled" wire:target="createTool">
                                    <span class="mx-1">
