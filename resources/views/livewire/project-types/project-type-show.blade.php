            ...
            <div class="md:px-5 pb-5">
                <div class="md:mx-6">
                    <div class="bg-gray-500 p-4 rounded-lg text-white text-center">
                        ...
                        <p class="p-2 text-green-500 rounded-md text-lg text-center uppercase">{{ $type->status }}</p>
                        @else
                        <p class="p-2 text-red-400 rounded-md text-lg text-center uppercase">{{ $type->status }}</p>
                        @endif
                    </div>
                </div>
            </div>
