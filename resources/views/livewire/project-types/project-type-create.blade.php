<div>
    <button wire:click="$set('openCreate', true)"
        ...
        <span class="relative text-gray-500 transition duration-700 group-hover:text-white ease"><i
                class="fa fa-solid fa-plus-circle text-xl"></i> Agregar</span>
    </button>
                        ...
                        <div>
                            <div
                                ...
                                <span class="pl-2 mx-1">
                                    <h2 class="mt-3 text-2xl text-center">Crear Categoría de Proyecto</h2>
                                </span>
                            </div>
                        ...
                        <div class="mx-auto">
                            <div class="flex gap-16">
                                ...
                                <button type="button"
                                    ...
                                    wire:click="createProjectType" wire:loading.attr="disabled"
                                    wire:target="createProjectType">
                                    <span class="mx-1">
