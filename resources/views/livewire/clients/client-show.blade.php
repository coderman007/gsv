                ...
                <div class="w-full bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="px-6 py-8">
                        ...
                        <div class="flex flex-col items-center mb-6">
                            ...
                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">Tipo de Cliente</h1>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-md text-gray-800 dark:text-white">{{ $client->document }}</p>
                            </div>

                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">Correo Electrónico
                                </h1>
                                <p class="text-lg text-gray-800 dark:text-white">{{ $client->email }}</p>
                            </div>

                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">Dirección</h1>
                                <p class="text-lg text-gray-800 dark:text-white">{{ $client->address }}</p>
                            </div>

                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">Teléfono</h1>
                                <p class="text-lg text-gray-800 dark:text-white">{{ $client->phone }}</p>
                            </div>

                            <div class="mb-4">
                                <h1 class="text-md font-semibold text-gray-600 dark:text-gray-400">Estado</h1>
