                    ...
                    <div class="min-h-screen p-6 bg-gray-100">
                        <div class="container mx-auto">
                            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                <div class="grid gap-4 gap-y-2 text-sm md:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div class="md:col-span-5">
                                                ...
                                                <input type="number" id="average_energy_consumption"
                                                    wire:model="average_energy_consumption"
                                                    id="average_energy_consumption" name="average_energy_consumption"
                                                    class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300">
