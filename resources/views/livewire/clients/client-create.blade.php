        ...
        <div class="w-1">
            <x-slot name="content">
                <form>
                    ...
                    <div class="mb-4">
                        <label for="average_energy_consumption" class="block text-sm font-medium text-gray-700">Consumo
                            de Energía Promedio</label>
                        <input type="number" wire:model="average_energy_consumption" id="average_energy_consumption"
                    ...
                    <div class="mb-4">
                        <label for="solar_radiation_level" class="block text-sm font-medium text-gray-700">Nivel de
                            Radiación Solar</label>
                        <input type="number" wire:model="solar_radiation_level" id="solar_radiation_level"
                            name="solar_radiation_level"
                            class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300">
                    ...
                    <!-- Longitud Cubierta -->
                    <div class="mb-4">
                        <label for="roof_dimensions_length" class="block text-sm font-medium text-gray-700">Longitud
                            Cubierta</label>
                        <input type="number" wire:model="roof_dimensions_length" id="roof_dimensions_length"
                            name="roof_dimensions_length"
                            class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300">
                    ...
                    <!-- Ancho Cubierta -->
                    <div class="mb-4">
                        <label for="roof_dimensions_width" class="block text-sm font-medium text-gray-700">Ancho
                            Cubierta</label>
                        <input type="number" wire:model="roof_dimensions_width" id="roof_dimensions_width"
                            name="roof_dimensions_width"
                            class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300">
            ...
            <x-slot name="footer">
                <div class="mx-auto">
                    ...
                    <x-secondary-button
                        ...
                        wire:click="createClient" wire:loading.attr="disabled" wire:target="createClient">
                        Agregar
                    </x-secondary-button>
                </div>
            </x-slot>
