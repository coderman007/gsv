        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="hover:text-blue-500" href="{{ route('dashboard') }}"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="hover:text-blue-500" href="{{ route('users') }}"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="hover:text-blue-500" href="{{ route('clients') }}"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="hover:text-blue-500" href="{{ route('quotations') }}"
                        :active="request()->routeIs('quotations', 'quotation.create')">
                        {{ __('Cotizaciones') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden pt-4 space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link class="hover:text-blue-500" href="{{ route('tools') }}"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="hover:text-blue-500" href="{{ route('layouts') }}"
                        :active="request()->routeIs('layouts')">
                        {{ __('Plantillas') }}
                    </x-nav-link>
                </div>
