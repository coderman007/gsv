<div class="flex justify-between mb-4">
    <div class="rounded flex items-center">
        <a href="{{ route('welcome') }}" class="flex items-center">
            <img src="{{ asset('images/logo.jpg') }}" width="80" class="rounded-full shadow-white-2xl dark:shadow-black-2xl brightness-90 hover:brightness-150 transition duration-700 ease-in-out" alt="Logo GSV">
        </a>
